...
import com.realitysink.cover.CoverProfiler.Counter.TimeKind;

@Registration(id = CoverProfiler.ID)
public class CoverProfiler extends TruffleInstrument {

    public static final String ID = "cover_profiler";
    ...
    protected void onCreate(final Env env) {
        ...
        env.getInstrumenter().attachFactory(filterBuilder.tagIs(StandardTags.StatementTag.class).build(), new ExecutionEventNodeFactory() {
    ...
    private void printHistogram(PrintStream out, List<Counter> sortedCounters, final TimeKind time) {
        ...
        out.println(String.format("%12s | %7s | %14s | %7s | %11s | %-30s | %s ", //
        ...
        for (Counter counter : sortedCounters) {
            ...
            out.println(String.format("%12d |%6.0fms |%13.7fms |%7.0fms |%10.3fms | %-30s | %s", //
    ...
    private static class TimedCounterNode extends CounterNode {
        ...
        TimedCounterNode(CoverProfiler profiler, Counter counter, EventContext context) {
        ...
        static CounterNode create(CoverProfiler profiler, Counter counter, EventContext context) {
    ...
    private static class CounterNode extends ExecutionEventNode {
        ...
        protected final CoverProfiler profiler;
        protected final Counter counter;

        CounterNode(CoverProfiler profiler, Counter counter) {
    ...
    static void setTestHook(TestHook testHook) {
        CoverProfiler.testHook = testHook;
    }

    interface TestHook {

        void onCreate(CoverProfiler profiler);
    }
